        ...
        Behavior.levelLoading (fun wad level em ->
            ...
            |> Option.iter (function
                | Doom doomThing ->
                    ...
                    em.Add (cameraEnt, CameraComponent (Matrix4x4.CreatePerspectiveFieldOfView (56.25f * 0.0174533f, ((16.f + 16.f * 0.25f) / 9.f), 16.f, 100000.f), LayerMask.Layer1 ||| LayerMask.Layer2, ClearFlags.All, 0))
